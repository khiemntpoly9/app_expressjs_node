...
router.get('/category', cateController.getAllCate);
router.get('/category/:id', cateController.getCateById);
router.put('/category/update/:id', cateController.updateCate);
router.delete('/category/del/:id', cateController.deleteCate);
